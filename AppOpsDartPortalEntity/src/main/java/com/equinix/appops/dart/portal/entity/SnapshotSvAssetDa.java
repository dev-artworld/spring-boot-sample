...
/**
 * The persistent class for the SNAPSHOT_SV_ASSET_DA database table.
 * 
 ...
 */
@Entity
@Table(name = "SNAPSHOT_SV_ASSET_DA", schema = "EQX_DART")
@NamedQuery(name = "SnapshotSvAssetDa.findAll", query = "SELECT s FROM SnapshotSvAssetDa s")
public class SnapshotSvAssetDa implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2191099296228769070L;

	public SnapshotSvAssetDa() {
	...
	@OneToMany(mappedBy = "snapshotSvAssetDa"/* ,fetch=FetchType.EAGER */)
	...
	public void setSrcCxiErrorTbls(List<CxiErrorTbl> cxiErrorTbls) {
