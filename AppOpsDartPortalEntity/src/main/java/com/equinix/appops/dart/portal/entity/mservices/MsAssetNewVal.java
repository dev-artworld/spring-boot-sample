...
/**
 * The persistent class for the MS_ASSET_NEW_VAL database table.
 * 
 */
@Entity
@Table(name="MS_ASSET_NEW_VAL", schema="EQX_DART")
@NamedQuery(name="MsAssetNewVal.findAll", query="SELECT a FROM MsAssetNewVal a")
public class MsAssetNewVal implements Serializable {
...
//	private String header70;
	...
	*/
	...
	/*@Transient
	List<AssetNewVal> cabinetList = new ArrayList<AssetNewVal>(0);*/
	
	@Transient
	boolean usidTempChange;
	
	@Transient
	boolean assetIdTempChange;
	
	/*public List<AssetNewVal> getCabinetList() {
		return cabinetList;
	}

	@Transient
	public void setCabinetList(List<AssetNewVal> cabinetList) {
		this.cabinetList = cabinetList;
	}*/
	
	
	public boolean isUsidTempChange() {
		return usidTempChange;
	}

	@Transient
	public void setUsidTempChange(boolean usidTempChange) {
		this.usidTempChange = usidTempChange;
	}

	
	public boolean isAssetIdTempChange() {
		return assetIdTempChange;
	}

	@Transient
	public void setAssetIdTempChange(boolean assetIdTempChange) {
		this.assetIdTempChange = assetIdTempChange;
	}

	public MsAssetNewVal() {
	}
	...
	public List<Object> getNotNull() throws IllegalAccessException {
	...
	public String getNccSide() {
		return nccSide;
	}

	public void setNccSide(String nccSide) {
		this.nccSide = nccSide;
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("AssetNewVal [dfrId=");
		builder.append(dfrId);
		builder.append(", dfrLineId=");
		builder.append(dfrLineId);
		builder.append(", displayFlag=");
		builder.append(displayFlag);
		builder.append(", header1=");
		builder.append(header1);
		builder.append(", header2=");
		builder.append(header2);
		builder.append(", header3=");
		builder.append(header3);
		builder.append(", header4=");
		builder.append(header4);
		builder.append(", header5=");
		builder.append(header5);
		builder.append(", header6=");
		builder.append(header6);
		builder.append(", header7=");
		builder.append(header7);
		builder.append(", header8=");
		builder.append(header8);
		builder.append(", header9=");
		builder.append(header9);
		builder.append(", header10=");
		builder.append(header10);
		builder.append(", header11=");
		builder.append(header11);
		builder.append(", header12=");
		builder.append(header12);
		builder.append(", header13=");
		builder.append(header13);
		builder.append(", header14=");
		builder.append(header14);
		builder.append(", header15=");
		builder.append(header15);
		builder.append(", header16=");
		builder.append(header16);
		builder.append(", header17=");
		builder.append(header17);
		builder.append(", header18=");
		builder.append(header18);
		builder.append(", header19=");
		builder.append(header19);
		builder.append(", header20=");
		builder.append(header20);
		builder.append(", header21=");
		builder.append(header21);
		builder.append(", header22=");
		builder.append(header22);
		builder.append(", header23=");
		builder.append(header23);
		builder.append(", header24=");
		builder.append(header24);
		builder.append(", header25=");
		builder.append(header25);
		builder.append(", header26=");
		builder.append(header26);
		builder.append(", header27=");
		builder.append(header27);
		builder.append(", header28=");
		builder.append(header28);
		builder.append(", header29=");
		builder.append(header29);
		builder.append(", header30=");
		builder.append(header30);
		builder.append(", header31=");
		builder.append(header31);
		builder.append(", header32=");
		builder.append(header32);
		builder.append(", header33=");
		builder.append(header33);
		builder.append(", header34=");
		builder.append(header34);
		builder.append(", header35=");
		builder.append(header35);
		builder.append(", header36=");
		builder.append(header36);
		builder.append(", header37=");
		builder.append(header37);
		builder.append(", header38=");
		builder.append(header38);
		builder.append(", header39=");
		builder.append(header39);
		builder.append(", header40=");
		builder.append(header40);
		builder.append(", header41=");
		builder.append(header41);
		builder.append(", header42=");
		builder.append(header42);
		builder.append(", header43=");
		builder.append(header43);
		builder.append(", header44=");
		builder.append(header44);
		builder.append(", header45=");
		builder.append(header45);
		builder.append(", header46=");
		builder.append(header46);
		builder.append(", header47=");
		builder.append(header47);
		builder.append(", header48=");
		builder.append(header48);
		builder.append(", header49=");
		builder.append(header49);
		builder.append(", header50=");
		builder.append(header50);
		builder.append(", header51=");
		builder.append(header51);
		builder.append(", header52=");
		builder.append(header52);
		builder.append(", header53=");
		builder.append(header53);
		builder.append(", header54=");
		builder.append(header54);
		builder.append(", header55=");
		builder.append(header55);
		builder.append(", header56=");
		builder.append(header56);
		builder.append(", header57=");
		builder.append(header57);
		builder.append(", header58=");
		builder.append(header58);
		builder.append(", header59=");
		builder.append(header59);
		builder.append(", header60=");
		builder.append(header60);
		builder.append(", header61=");
		builder.append(header61);
		builder.append(", header62=");
		builder.append(header62);
		builder.append(", header63=");
		builder.append(header63);
		builder.append(", header64=");
		builder.append(header64);
		builder.append(", header65=");
		builder.append(header65);
		builder.append(", header66=");
		builder.append(header66);
		...
		builder.append(attr4);
		builder.append(", attr5=");
		builder.append(attr5);
		builder.append(", attr6=");
		builder.append(attr6);
		builder.append(", attr7=");
		builder.append(attr7);
		builder.append(", attr8=");
		builder.append(attr8);
		builder.append(", attr9=");
		builder.append(attr9);
		builder.append(", attr10=");
		builder.append(attr10);
		builder.append(", attr11=");
		builder.append(attr11);
		builder.append(", attr12=");
		builder.append(attr12);
		builder.append(", attr13=");
		builder.append(attr13);
		builder.append(", attr14=");
		builder.append(attr14);
		builder.append(", attr15=");
		builder.append(attr15);
		builder.append(", attr16=");
		builder.append(attr16);
		builder.append(", attr17=");
		builder.append(attr17);
		builder.append(", attr18=");
		builder.append(attr18);
		builder.append(", attr19=");
		builder.append(attr19);
		builder.append(", attr20=");
		builder.append(attr20);
		builder.append(", attr21=");
		builder.append(attr21);
		builder.append(", attr22=");
		builder.append(attr22);
		builder.append(", attr23=");
		builder.append(attr23);
		builder.append(", attr24=");
		builder.append(attr24);
		builder.append(", attr25=");
		builder.append(attr25);
		builder.append(", attr26=");
		builder.append(attr26);
		builder.append(", attr27=");
		builder.append(attr27);
		builder.append(", attr28=");
		builder.append(attr28);
		builder.append(", attr29=");
		builder.append(attr29);
		builder.append(", attr30=");
		builder.append(attr30);
		builder.append(", attr31=");
		builder.append(attr31);
		builder.append(", attr32=");
		builder.append(attr32);
		builder.append(", attr33=");
		builder.append(attr33);
		builder.append(", attr34=");
		builder.append(attr34);
		builder.append(", attr35=");
		builder.append(attr35);
		builder.append(", attr36=");
		builder.append(attr36);
		builder.append(", attr37=");
		builder.append(attr37);
		builder.append(", attr38=");
		builder.append(attr38);
		builder.append(", attr39=");
		builder.append(attr39);
		builder.append(", attr40=");
		builder.append(attr40);
		builder.append(", attr41=");
		builder.append(attr41);
		builder.append(", attr42=");
		builder.append(attr42);
		builder.append(", attr43=");
		builder.append(attr43);
		builder.append(", attr44=");
		builder.append(attr44);
		builder.append(", attr45=");
		builder.append(attr45);
		builder.append(", attr46=");
		builder.append(attr46);
		builder.append(", attr47=");
		builder.append(attr47);
		builder.append(", attr48=");
		builder.append(attr48);
		builder.append(", attr49=");
		builder.append(attr49);
		builder.append(", attr50=");
		builder.append(attr50);
		builder.append(", attr51=");
		builder.append(attr51);
		builder.append(", attr52=");
		builder.append(attr52);
		builder.append(", attr53=");
		builder.append(attr53);
		builder.append(", attr54=");
		builder.append(attr54);
		builder.append(", attr55=");
		builder.append(attr55);
		builder.append(", attr56=");
		builder.append(attr56);
		builder.append(", attr57=");
		builder.append(attr57);
		builder.append(", attr58=");
		builder.append(attr58);
		builder.append(", attr59=");
		builder.append(attr59);
		builder.append(", attr60=");
		builder.append(attr60);
		builder.append(", attr61=");
		builder.append(attr61);
		builder.append(", attr62=");
		builder.append(attr62);
		builder.append(", attr63=");
		builder.append(attr63);
		builder.append(", attr64=");
		builder.append(attr64);
		builder.append(", attr65=");
		builder.append(attr65);
		builder.append(", attr66=");
		builder.append(attr66);
		builder.append(", attr67=");
		builder.append(attr67);
		builder.append(", attr68=");
		builder.append(attr68);
		builder.append(", attr69=");
		builder.append(attr69);
		builder.append(", attr70=");
		builder.append(attr70);
		builder.append(", attr71=");
		builder.append(attr71);
		builder.append(", attr72=");
		builder.append(attr72);
		builder.append(", attr73=");
		builder.append(attr73);
		builder.append(", attr74=");
		builder.append(attr74);
		builder.append(", attr75=");
		builder.append(attr75);
		builder.append(", attr76=");
		builder.append(attr76);
		builder.append(", attr77=");
		builder.append(attr77);
		builder.append(", attr78=");
		builder.append(attr78);
		builder.append(", attr79=");
		builder.append(attr79);
		builder.append(", attr80=");
		builder.append(attr80);
		builder.append(", attr81=");
		builder.append(attr81);
		builder.append(", attr82=");
		builder.append(attr82);
		builder.append(", attr83=");
		builder.append(attr83);
		builder.append(", attr84=");
		builder.append(attr84);
		builder.append(", attr85=");
		builder.append(attr85);
		builder.append(", attr86=");
		builder.append(attr86);
		builder.append(", attr87=");
		builder.append(attr87);
		builder.append(", attr88=");
		builder.append(attr88);
		builder.append(", attr89=");
		builder.append(attr89);
		builder.append(", attr90=");
		builder.append(attr90);
		builder.append(", attr91=");
		builder.append(attr91);
		builder.append(", attr92=");
		builder.append(attr92);
		builder.append(", attr93=");
		builder.append(attr93);
		builder.append(", attr94=");
		builder.append(attr94);
		builder.append(", attr95=");
		builder.append(attr95);
		builder.append(", attr96=");
		builder.append(attr96);
		builder.append(", attr97=");
		builder.append(attr97);
		builder.append(", attr98=");
		builder.append(attr98);
		builder.append(", attr99=");
		builder.append(attr99);
		builder.append(", attr100=");
		builder.append(attr100);
		builder.append(", attr101=");
		builder.append(attr101);
		builder.append(", attr102=");
		builder.append(attr102);
		builder.append(", attr103=");
		builder.append(attr103);
		builder.append(", attr104=");
		builder.append(attr104);
		builder.append(", attr105=");
		builder.append(attr105);
		builder.append(", attr106=");
		builder.append(attr106);
		builder.append(", attr107=");
		builder.append(attr107);
		builder.append(", attr108=");
		builder.append(attr108);
		builder.append(", attr109=");
		builder.append(attr109);
		builder.append(", attr110=");
		builder.append(attr110);
		builder.append(", attr111=");
		builder.append(attr111);
		builder.append(", attr112=");
		builder.append(attr112);
		builder.append(", attr113=");
		builder.append(attr113);
		builder.append(", attr114=");
		builder.append(attr114);
		builder.append(", attr115=");
		builder.append(attr115);
		builder.append(", attr116=");
		builder.append(attr116);
		builder.append(", attr117=");
		builder.append(attr117);
		builder.append(", attr118=");
		builder.append(attr118);
		builder.append(", attr119=");
		builder.append(attr119);
		builder.append(", attr120=");
		builder.append(attr120);
		builder.append(", attr121=");
		builder.append(attr121);
		builder.append(", attr122=");
		builder.append(attr122);
		builder.append(", attr123=");
		builder.append(attr123);
		builder.append(", attr124=");
		builder.append(attr124);
		builder.append(", attr125=");
		builder.append(attr125);
		builder.append(", attr126=");
		builder.append(attr126);
		builder.append(", attr127=");
		builder.append(attr127);
		builder.append(", attr128=");
		builder.append(attr128);
		builder.append(", attr129=");
		builder.append(attr129);
		builder.append(", attr130=");
		builder.append(attr130);
		builder.append(", attr131=");
		builder.append(attr131);
		builder.append(", attr132=");
		builder.append(attr132);
		builder.append(", attr133=");
		builder.append(attr133);
		builder.append(", attr134=");
		builder.append(attr134);
		builder.append(", attr135=");
		builder.append(attr135);
		builder.append(", attr136=");
		builder.append(attr136);
		builder.append(", attr137=");
		builder.append(attr137);
		builder.append(", attr138=");
		builder.append(attr138);
		builder.append(", attr139=");
		builder.append(attr139);
		builder.append(", attr140=");
		builder.append(attr140);
		builder.append(", attr141=");
		builder.append(attr141);
		builder.append(", attr142=");
		builder.append(attr142);
		builder.append(", attr143=");
		builder.append(attr143);
		builder.append(", attr144=");
		builder.append(attr144);
		builder.append(", attr145=");
		builder.append(attr145);
		builder.append(", attr146=");
		builder.append(attr146);
		builder.append(", attr147=");
		builder.append(attr147);
		builder.append(", attr148=");
		builder.append(attr148);
		builder.append(", attr149=");
		builder.append(attr149);
		builder.append(", attr150=");
		builder.append(attr150);
		builder.append(", attr151=");
		builder.append(attr151);
		builder.append(", attr152=");
		builder.append(attr152);
		builder.append(", attr153=");
		builder.append(attr153);
		builder.append(", attr154=");
		builder.append(attr154);
		builder.append(", attr155=");
		builder.append(attr155);
		builder.append(", attr156=");
		builder.append(attr156);
		builder.append(", attr157=");
		builder.append(attr157);
		builder.append(", attr158=");
		builder.append(attr158);
		builder.append(", attr159=");
		builder.append(attr159);
		builder.append(", attr160=");
		builder.append(attr160);
		builder.append(", attr161=");
		builder.append(attr161);
		builder.append(", attr162=");
		builder.append(attr162);
		builder.append(", attr163=");
		builder.append(attr163);
		builder.append(", attr164=");
		builder.append(attr164);
		builder.append(", attr165=");
		builder.append(attr165);
		builder.append(", attr166=");
		builder.append(attr166);
		builder.append(", attr167=");
		builder.append(attr167);
		builder.append(", attr168=");
		builder.append(attr168);
		builder.append(", attr169=");
		builder.append(attr169);
		builder.append(", attr170=");
		builder.append(attr170);
		builder.append(", attr171=");
		builder.append(attr171);
		builder.append(", attr172=");
		builder.append(attr172);
		builder.append(", attr173=");
		builder.append(attr173);
		builder.append(", attr174=");
		builder.append(attr174);
		builder.append(", attr175=");
		builder.append(attr175);
		builder.append(", attr176=");
		builder.append(attr176);
		builder.append(", attr177=");
		builder.append(attr177);
		builder.append(", attr178=");
		builder.append(attr178);
		builder.append(", attr179=");
		builder.append(attr179);
		builder.append(", attr180=");
		builder.append(attr180);
		builder.append(", attr181=");
		builder.append(attr181);
		builder.append(", attr182=");
		builder.append(attr182);
		builder.append(", attr183=");
		builder.append(attr183);
		builder.append(", attr184=");
		builder.append(attr184);
		builder.append(", attr185=");
		builder.append(attr185);
		builder.append(", attr186=");
		builder.append(attr186);
		builder.append(", attr187=");
		builder.append(attr187);
		builder.append(", attr188=");
		builder.append(attr188);
		builder.append(", attr189=");
		builder.append(attr189);
		builder.append(", attr190=");
		builder.append(attr190);
		builder.append(", attr191=");
		builder.append(attr191);
		builder.append(", attr192=");
		builder.append(attr192);
		builder.append(", attr193=");
		builder.append(attr193);
		builder.append(", attr194=");
		builder.append(attr194);
		builder.append(", attr195=");
		builder.append(attr195);
		builder.append(", attr196=");
		builder.append(attr196);
		builder.append(", attr197=");
		builder.append(attr197);
		builder.append(", attr198=");
		builder.append(attr198);
		builder.append(", attr199=");
		builder.append(attr199);
		builder.append(", attr200=");
		builder.append(attr200);
		builder.append(", attr201=");
		builder.append(attr201);
		builder.append(", attr202=");
		builder.append(attr202);
		builder.append(", attr203=");
		builder.append(attr203);
		builder.append(", attr204=");
		builder.append(attr204);
		builder.append(", attr205=");
		builder.append(attr205);
		builder.append(", attr206=");
		builder.append(attr206);
		builder.append(", attr207=");
		builder.append(attr207);
		builder.append(", attr208=");
		builder.append(attr208);
		builder.append(", attr209=");
		builder.append(attr209);
		builder.append(", attr210=");
		builder.append(attr210);
		builder.append(", attr211=");
		builder.append(attr211);
		builder.append(", attr212=");
		builder.append(attr212);
		builder.append(", attr213=");
		builder.append(attr213);
		builder.append(", attr214=");
		builder.append(attr214);
		builder.append(", attr215=");
		builder.append(attr215);
		builder.append(", attr216=");
		builder.append(attr216);
		builder.append(", attr217=");
		builder.append(attr217);
		builder.append(", attr218=");
		builder.append(attr218);
		builder.append(", attr219=");
		builder.append(attr219);
		builder.append(", attr220=");
		builder.append(attr220);
		builder.append(", attr221=");
		builder.append(attr221);
		builder.append(", attr222=");
		builder.append(attr222);
		builder.append(", attr223=");
		builder.append(attr223);
		builder.append(", attr224=");
		builder.append(attr224);
		builder.append(", attr225=");
		builder.append(attr225);
		builder.append(", attr226=");
		builder.append(attr226);
		builder.append(", attr227=");
		builder.append(attr227);
		builder.append(", attr228=");
		builder.append(attr228);
		builder.append(", attr229=");
		builder.append(attr229);
		builder.append(", attr230=");
		builder.append(attr230);
		builder.append(", attr231=");
		builder.append(attr231);
		builder.append(", attr232=");
		builder.append(attr232);
		builder.append(", attr233=");
		builder.append(attr233);
		builder.append(", attr234=");
		builder.append(attr234);
		builder.append(", attr235=");
		builder.append(attr235);
		builder.append(", attr236=");
		builder.append(attr236);
		builder.append(", attr237=");
		builder.append(attr237);
		builder.append(", attr238=");
		builder.append(attr238);
		builder.append(", attr239=");
		builder.append(attr239);
		builder.append(", attr240=");
		builder.append(attr240);
		builder.append(", attr241=");
		builder.append(attr241);
		builder.append(", attr242=");
		builder.append(attr242);
		builder.append(", attr243=");
		builder.append(attr243);
		builder.append(", attr244=");
		builder.append(attr244);
		builder.append(", attr245=");
		builder.append(attr245);
		builder.append(", attr246=");
		builder.append(attr246);
		builder.append(", attr247=");
		builder.append(attr247);
		builder.append(", attr248=");
		builder.append(attr248);
		builder.append(", attr249=");
		builder.append(attr249);
		builder.append(", attr250=");
		builder.append(attr250);
		builder.append(", attr251=");
		builder.append(attr251);
		builder.append(", attr252=");
		builder.append(attr252);
		builder.append(", attr253=");
		builder.append(attr253);
		builder.append(", attr254=");
		builder.append(attr254);
		builder.append(", attr255=");
		builder.append(attr255);
		builder.append(", attr256=");
		builder.append(attr256);
		builder.append(", attr257=");
		builder.append(attr257);
		builder.append(", attr258=");
		builder.append(attr258);
		builder.append(", attr259=");
		builder.append(attr259);
		builder.append(", attr260=");
		builder.append(attr260);
		builder.append(", attr261=");
		builder.append(attr261);
		builder.append(", attr262=");
		builder.append(attr262);
		builder.append(", attr263=");
		builder.append(attr263);
		builder.append(", attr264=");
		builder.append(attr264);
		builder.append(", attr265=");
		builder.append(attr265);
		builder.append(", attr266=");
		builder.append(attr266);
		builder.append(", attr267=");
		builder.append(attr267);
		builder.append(", attr268=");
		builder.append(attr268);
		builder.append(", attr269=");
		builder.append(attr269);
		builder.append(", attr270=");
		builder.append(attr270);
		builder.append(", attr271=");
		builder.append(attr271);
		builder.append(", attr272=");
		builder.append(attr272);
		builder.append(", attr273=");
		builder.append(attr273);
		builder.append(", attr274=");
		builder.append(attr274);
		builder.append(", attr275=");
		builder.append(attr275);
		builder.append(", attr276=");
		builder.append(attr276);
		builder.append(", attr277=");
		builder.append(attr277);
		builder.append(", attr278=");
		builder.append(attr278);
		builder.append(", attr279=");
		builder.append(attr279);
		builder.append(", attr280=");
		builder.append(attr280);
		builder.append(", attr281=");
		builder.append(attr281);
		builder.append(", attr282=");
		builder.append(attr282);
		builder.append(", attr283=");
		builder.append(attr283);
		builder.append(", attr284=");
		builder.append(attr284);
		builder.append(", attr285=");
		builder.append(attr285);
		builder.append(", attr286=");
		builder.append(attr286);
		builder.append(", attr287=");
		builder.append(attr287);
		builder.append(", attr288=");
		builder.append(attr288);
		builder.append(", attr289=");
		builder.append(attr289);
		builder.append(", attr290=");
		builder.append(attr290);
		builder.append(", attr291=");
		builder.append(attr291);
		builder.append(", attr292=");
		builder.append(attr292);
		builder.append(", attr293=");
		builder.append(attr293);
		builder.append(", attr294=");
		builder.append(attr294);
		builder.append(", attr295=");
		builder.append(attr295);
		builder.append(", attr296=");
		builder.append(attr296);
		builder.append(", attr297=");
		builder.append(attr297);
		builder.append(", attr298=");
		builder.append(attr298);
		builder.append(", attr299=");
		builder.append(attr299);
		builder.append(", attr300=");
		builder.append(attr300);
		builder.append(", attr301=");
		builder.append(attr301);
		builder.append(", attr302=");
		builder.append(attr302);
		builder.append(", attr303=");
		builder.append(attr303);
		builder.append(", attr304=");
		builder.append(attr304);
		builder.append(", attr305=");
		builder.append(attr305);
		builder.append(", attr306=");
		builder.append(attr306);
		builder.append(", attr307=");
		builder.append(attr307);
		builder.append(", attr308=");
		builder.append(attr308);
		builder.append(", attr309=");
		builder.append(attr309);
		builder.append(", attr310=");
		builder.append(attr310);
		builder.append(", attr311=");
		builder.append(attr311);
		builder.append(", attr312=");
		builder.append(attr312);
		builder.append(", attr313=");
		builder.append(attr313);
		builder.append(", attr314=");
		builder.append(attr314);
		builder.append(", attr315=");
		builder.append(attr315);
		builder.append(", attr316=");
		builder.append(attr316);
		builder.append(", attr317=");
		builder.append(attr317);
		builder.append(", attr318=");
		builder.append(attr318);
		builder.append(", attr319=");
		builder.append(attr319);
		builder.append(", attr320=");
		builder.append(attr320);
		builder.append(", attr321=");
		builder.append(attr321);
		builder.append(", attr322=");
		builder.append(attr322);
		builder.append(", attr323=");
		builder.append(attr323);
		builder.append(", attr324=");
		builder.append(attr324);
		builder.append(", attr325=");
		builder.append(attr325);
		builder.append(", attr326=");
		builder.append(attr326);
		builder.append(", attr327=");
		builder.append(attr327);
		builder.append(", attr328=");
		builder.append(attr328);
		builder.append(", attr329=");
		builder.append(attr329);
		builder.append(", attr330=");
		builder.append(attr330);
		builder.append(", attr331=");
		builder.append(attr331);
		builder.append(", attr332=");
		builder.append(attr332);
		builder.append(", attr333=");
		builder.append(attr333);
		builder.append(", attr334=");
		builder.append(attr334);
		builder.append(", attr335=");
		builder.append(attr335);
		builder.append(", attr336=");
		builder.append(attr336);
		builder.append(", attr337=");
		builder.append(attr337);
		builder.append(", attr338=");
		builder.append(attr338);
		builder.append(", attr339=");
		builder.append(attr339);
		builder.append(", attr340=");
		builder.append(attr340);
		builder.append(", attr341=");
		builder.append(attr341);
		builder.append(", attr342=");
		builder.append(attr342);
		builder.append(", attr343=");
		builder.append(attr343);
		builder.append(", attr344=");
		builder.append(attr344);
		builder.append(", attr345=");
		builder.append(attr345);
		builder.append(", attr346=");
		builder.append(attr346);
		builder.append(", attr347=");
		builder.append(attr347);
		builder.append(", attr348=");
		builder.append(attr348);
		builder.append(", attr349=");
		builder.append(attr349);
		builder.append(", attr350=");
		builder.append(attr350);
		builder.append(", cabinetList=");
	//	builder.append(cabinetList);
		builder.append("]");
