...
/**
 * The persistent class for the SNOW_ASSET_DA database table.
 *
 */
@Entity
@Table(name="SNOW_ASSET_DA",schema="EQX_DART")
@NamedQuery(name="SnowAssetDa.findAll", query="SELECT sa FROM SnowAssetDa sa")
public class SnowAssetDa implements Serializable {
    ...
    public SnowAssetDa(Object[] data) {
        try{
