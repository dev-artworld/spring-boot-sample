...
/**
 * The persistent class for the SNAPSHOT_SNOW_ASSET_DA database table.
 *
 */
@Entity
@Table(name="SNAPSHOT_SNOW_ASSET_DA",schema="EQX_DART")
@NamedQuery(name="SnapshotSnowAssetDa.findAll", query="SELECT sa FROM SnapshotSnowAssetDa sa")
public class SnapshotSnowAssetDa implements Serializable {
    ...
    public SnapshotSnowAssetDa(Object[] data) {
        try{
            this.header1 = (String)data[0];
            this.header2 = (String)data[1];
            this.header3 = (String)data[2];
            this.header4 = (String)data[3];
            this.header5 = (String)data[4];
            this.header6 = (String)data[5];
            this.header7 = (String)data[6];
            this.header8 = (String)data[7];
            this.header9 = (String)data[8];
            this.header10 = (String)data[9];
            this.header11 = (String)data[10];
            this.header12 = (String)data[11];
            this.header13 = (String)data[12];
            this.header14 = (String)data[13];
            this.header16 = (String)data[14];
            this.header20 = (String)data[15];
            this.header22 = (String)data[16];
            this.header27 = (String)data[17];
            this.header38 = (String)data[18];
            this.attr22 = (String)data[19];
        }catch(Exception e){
            e.printStackTrace();
        }
	...
	@OneToMany(mappedBy = "snapshotSnowAssetDa",cascade = { CascadeType.ALL })
	private List<MsCxiErrorTbl> cxiErrorTbls;
	...
	public List<MsCxiErrorTbl> getCxiErrorTbls() {
		return cxiErrorTbls;
	}

	public void setCxiErrorTbls(List<MsCxiErrorTbl> cxiErrorTbls) {
