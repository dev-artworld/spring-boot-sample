...
/**
 * The persistent class for the CLX_ASSET_DA database table.
 * 
 */
@Entity
@Table(name="CLX_ASSET_DA",schema="EQX_DART")
@NamedQuery(name="ClxAssetDa.findAll", query="SELECT c FROM ClxAssetDa c")
public class ClxAssetDa implements Serializable {
...
//		private String header70;
		...
		*/
		...
		/*@OneToMany(mappedBy="clxAssetDa",fetch=FetchType.EAGER)
