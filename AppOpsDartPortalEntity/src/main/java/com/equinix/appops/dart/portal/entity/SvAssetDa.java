...
/**
 * The persistent class for the SV_ASSET_DA database table.
 * @author Ankur Bhargava
 * 
 * 
 */
@Entity
@Table(name="SV_ASSET_DA",schema="EQX_DART")
@NamedQuery(name="SvAssetDa.findAll", query="SELECT s FROM SvAssetDa s")
public class SvAssetDa implements Serializable {
...
//	private String header70;
	...
	*/
	...
	/*@OneToMany(mappedBy="svAssetDa",fetch=FetchType.EAGER)
