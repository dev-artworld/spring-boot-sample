...
/**
 * The persistent class for the SIEBEL_ASSET_DA database table.
 * 
 */
@Entity
@Table(name="SIEBEL_ASSET_DA",schema="EQX_DART")
@NamedQuery(name="SiebelAssetDa.findAll", query="SELECT s FROM SiebelAssetDa s")
public class SiebelAssetDa implements Serializable {
	...
	public SiebelAssetDa(Object[] data) {
		try{
