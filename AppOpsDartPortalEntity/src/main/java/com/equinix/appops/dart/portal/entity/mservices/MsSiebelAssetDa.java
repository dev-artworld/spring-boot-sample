...
/**
 * The persistent class for the MS_SIEBEL_ASSET_DA database table.
 *
 */
@Entity
@Table(name="MS_SIEBEL_ASSET_DA",schema="EQX_DART")
@NamedQuery(name="MsSiebelAssetDa.findAll", query="SELECT ms FROM MsSiebelAssetDa ms")
public class MsSiebelAssetDa implements Serializable {
    ...
    public MsSiebelAssetDa(Object[] data) {
        try{
...
//		private String header70;
    ...
    //bi-directional many-to-one association to SrcCxiErrorTbl
		/*@OneToMany(mappedBy="siebelAssetDa",fetch=FetchType.LAZY)
		private List<SrcCxiErrorTbl> srcCxiErrorTbls;*/


    @Transient
    private List<SrcCxiErrorTbl> errorList;


    public List<SrcCxiErrorTbl> getErrorList() {
        return errorList;
    }

    public void setErrorList(List<SrcCxiErrorTbl> errorList) {
