...
/**
 * The persistent class for the EQX_CL_CABINET database table.
 * 
 */
@Entity
@Table(name="EQX_CL_CABINET", schema="EQX_DART")
@NamedQuery(name="EqxClCabinet.findAll", query="SELECT e FROM EqxClCabinet e")
public class EqxClCabinet implements Serializable {
