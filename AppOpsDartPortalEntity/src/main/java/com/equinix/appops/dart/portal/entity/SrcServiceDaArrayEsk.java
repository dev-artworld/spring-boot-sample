...
/**
 * The persistent class for the SRC_SERVICE_DA_ARRAY_ESK database table.
 * 
 */
@Entity
@Table(name="SRC_SERVICE_DA_ARRAY_ESK",schema="EQX_DART")
@NamedQuery(name="SrcServiceDaArrayEsk.findAll", query="SELECT s FROM SrcServiceDaArrayEsk s")
public class SrcServiceDaArrayEsk implements Serializable {
