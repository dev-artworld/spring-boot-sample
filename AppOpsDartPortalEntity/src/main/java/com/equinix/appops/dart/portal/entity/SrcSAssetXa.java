...
/**
 * The persistent class for the SRC_S_ASSET_XA database table.
 * 
 */
@Entity
@Table(name="SRC_S_ASSET_XA",schema="EQX_DART")
@NamedQuery(name="SrcSAssetXa.findAll", query="SELECT s FROM SrcSAssetXa s")
public class SrcSAssetXa implements Serializable {
