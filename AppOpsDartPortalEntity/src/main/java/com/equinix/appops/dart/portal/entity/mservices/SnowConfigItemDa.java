...
@Entity
@Table(name="SNOW_CONFIG_ITEM_DA",schema="EQX_DART")
@NamedQuery(name="SnowConfigItemDa.findAll", query="SELECT s FROM SnowConfigItemDa s")
public class SnowConfigItemDa implements Serializable{
