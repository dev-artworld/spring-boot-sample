...
/**
 * The persistent class for the MS_CI_DA_NEW_VAL database table.
 * 
 */
@Entity
@Table(name="MS_CI_DA_NEW_VAL", schema="EQX_DART")
@NamedQuery(name="MsCiDaNewVal.findAll", query="SELECT m FROM MsCiDaNewVal m")
public class MsCiDaNewVal implements Serializable {
