...
/**
 * The persistent class for the ASSET_NEW_VAL database table.
 * 
 */
@Entity
@Table(name="ASSET_NEW_VAL", schema="EQX_DART")
@NamedQuery(name="AssetNewVal.findAll", query="SELECT a FROM AssetNewVal a")
public class AssetNewVal implements Serializable {
