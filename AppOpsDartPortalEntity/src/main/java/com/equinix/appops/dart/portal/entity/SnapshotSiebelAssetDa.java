...
/**
 * The persistent class for the SNAPSHOT_SIEBEL_ASSET_DA database table.
 * 
 * @author Sandeep Singh
 * 
 */
@Entity
@Table(name = "SNAPSHOT_SIEBEL_ASSET_DA", schema = "EQX_DART")
@NamedQuery(name = "SnapshotSiebelAssetDa.findAll", query = "SELECT s FROM SnapshotSiebelAssetDa s")
public class SnapshotSiebelAssetDa implements Serializable {
	...
	*/
	...
	@OneToMany(mappedBy = "snapshotSiebelAssetDa",cascade = { CascadeType.ALL })
	private List<CxiErrorTbl> cxiErrorTbls;

	@Transient
	private List<CxiErrorTbl> errorList;
	
	/**
	 * DQM_ERROR_DESCRIPTION
	 */
	@Transient
	private String dqmErrorDescription;
	...
	/**
	 * GREEN_ROW_IDENTIFIER
	 */
	@Transient
	private String greenRowIdentifier;


	public List<CxiErrorTbl> getErrorList() {
		return errorList;
	}

	public void setErrorList(List<CxiErrorTbl> errorList) {
	...
	public SnapshotSiebelAssetDa() {

	}

	public String getDqmErrorDescription() {
		return dqmErrorDescription;
	}

	public void setDqmErrorDescription(String dqmErrorDescription) {
		this.dqmErrorDescription = dqmErrorDescription;
	}
