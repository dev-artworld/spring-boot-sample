...
/**
 * The persistent class for the EQX_CL_CAGE database table.
 * 
 */
@Entity
@Table(name="EQX_CL_CAGE", schema ="EQX_DART")
@NamedQuery(name="EqxClCage.findAll", query="SELECT e FROM EqxClCage e")
public class EqxClCage implements Serializable {
