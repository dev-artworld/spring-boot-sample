...
/**
 * The persistent class for the SRC_CXI_ERROR_TBL database table.
 * 
 */
@Entity
@Table(name="SRC_CXI_ERROR_TBL", schema="EQX_DART")
@NamedQuery(name="SrcCxiErrorTbl.findAll", query="SELECT s FROM SrcCxiErrorTbl s")
public class SrcCxiErrorTbl implements Serializable {
...
/*
	...
	@JoinColumn(name="SBL_RID",nullable=true)
	private SiebelAssetDa siebelAssetDa;*/
	...
	/*//bi-directional many-to-one association to SiebelAssetDa
	@ManyToOne (optional=false,fetch=FetchType.LAZY)
	@JoinColumn(name="CLX_RID",nullable=true)
	private ClxAssetDa clxAssetDa ;*/
	...
	/*//bi-directional many-to-one association to SiebelAssetDa
	@ManyToOne (optional=false,fetch=FetchType.LAZY)
	@JoinColumn(name="SV_RID",nullable=true)
	private SvAssetDa svAssetDa ;*/
	...
	/*public ClxAssetDa getClxAssetDa() {
		return clxAssetDa;
	}

	public void setClxAssetDa(ClxAssetDa clxAssetDa) {
		this.clxAssetDa = clxAssetDa;
	}

	public SvAssetDa getSvAssetDa() {
		return svAssetDa;
	}

	public void setSvAssetDa(SvAssetDa svAssetDa) {
		this.svAssetDa = svAssetDa;
	}*/
...
/*
	public SiebelAssetDa getSiebelAssetDa() {
		return this.siebelAssetDa;
	}

	public void setSiebelAssetDa(SiebelAssetDa siebelAssetDa) {
		this.siebelAssetDa = siebelAssetDa;
	}*/
